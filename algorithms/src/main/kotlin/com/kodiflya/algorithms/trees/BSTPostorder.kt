...
class BSTPostorder : AlgorithmPlugin {

    override val id = "bst_postorder"
    override val displayName = "Postorder"
    ...
    override fun steps(input: AlgorithmInput): Sequence<VisualizationStep> {
        ...
        return sequence {
            ...
            suspend fun SequenceScope<VisualizationStep>.postorder(nodeValue: Int?) {
